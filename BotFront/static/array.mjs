...
export const listCard = [
  ...
  {
      id:12,
      name: "Коробка для образовательных платформ и школ",
      price: 2700,
      description: "Образовательные платформы и онлайн-школы напоминают клиентам о занятиях, вебинарах и скидках на курсы. Иногда звонят и после мероприятий, чтобы провести опрос. Бот N. будет:",
      list: [
        "Приглашать на вебинар",
        "Оовещать о дате начала обучения", 
        "Подтверждать участие на открытый урок", 
        "Напоминать о необходимости зарегистрироваться на курс",
        "Информировать об изменении времени проведения события",
      ],
      priceFull: "СТОИМОСТЬ оповещения до 1000 участников в день - 2700 руб./мес.",
      connection: "absence/free/individ",
      integration: "absence/free/individ",
      addition: ["ВАЖНО! Интеграция с CRM позволит роботу получать данные для оповещений в режиме онлайн без контроля Человеком, что во многом упрощает работу с клиентами и автоматизирует рассылку ссылок."],
      actual: false,
      hot: false,
  },
  {
